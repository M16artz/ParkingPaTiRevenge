# Modelo de datos — Backend base de dominio y API
...
**Atributos mínimos:** id, calle_principal, calle_secundaria, nro_lote, fecha_creacion, fecha_actualizacion.  
**Validaciones:** campos obligatorios no vacíos; referencias existentes; estados dentro de catálogo cuando aplique.  
**Restricciones:** respetar permisos, unicidad y consistencia transaccional.
### Ubicacion

**Atributos mínimos:** id, longitud, latitud, fecha_creacion, fecha_actualizacion.  
**Validaciones:** campos obligatorios no vacíos; referencias existentes; estados dentro de catálogo cuando aplique.  
**Restricciones:** respetar permisos, unicidad y consistencia transaccional.
### Parqueadero

**Atributos mínimos:** id, nombre, estado, validado, disponibilidad, direccion_id, ubicacion_id.  
**Validaciones:** campos obligatorios no vacíos; referencias existentes; estados dentro de catálogo cuando aplique.  
**Restricciones:** respetar permisos, unicidad y consistencia transaccional.
### Rol <<Enum>>
...
**Atributos mínimos:** id, parqueadero_id, numero_espacio, estado.  
**Validaciones:** campos obligatorios no vacíos; referencias existentes; estados dentro de catálogo cuando aplique.  
**Restricciones:** respetar permisos, unicidad y consistencia transaccional.
### HorarioAtencion

**Atributos mínimos:** id, parqueadero_id, dia, hora_apertura, hora_cierre.  
**Validaciones:** campos obligatorios no vacíos; referencias existentes; estados dentro de catálogo cuando aplique.  
**Restricciones:** respetar permisos, unicidad y consistencia transaccional.
