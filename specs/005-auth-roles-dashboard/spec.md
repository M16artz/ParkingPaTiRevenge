# Feature 005 — Inicio de sesión y dashboard por roles
...
Como usuario del sistema, quiero completar el flujo de **Inicio de sesión y dashboard por roles** para avanzar en la operación de ParkingPaTi sin depender de pasos manuales externos.
...
**Dado** que el usuario se encuentra en el flujo de inicio de sesión y dashboard por roles,
...
- RF01. El sistema debe permitir servicio central de autenticación.
- RF02. Guardar tokens de forma segura para web y móvil.
- RF03. El sistema debe permitir guardas de rutas por rol.
- RF04. Redirigir propietario a panel propietario.
- RF05. Redirigir administrador a panel administrador.
- RF06. Permitir home anónimo sin token.
- RF07. El sistema debe permitir pruebas de rutas protegidas.
...
- **Sesion**: elemento necesario para cumplir la entrega.
- **Token**: elemento necesario para cumplir la entrega.
