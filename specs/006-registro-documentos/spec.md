# Feature 006 — Registro de usuarios y envío de documentos
...
Como usuario del sistema, quiero completar el flujo de **Registro de usuarios y envío de documentos** para avanzar en la operación de ParkingPaTi sin depender de pasos manuales externos.
...
**Dado** que el usuario se encuentra en el flujo de registro de usuarios y envío de documentos,
...
- RF01. El sistema debe permitir validaciones de identificación y correo.
- RF02. El sistema debe permitir formulario de registro.
- RF03. El sistema debe permitir servicio de subida multipart.
- RF04. El sistema debe validar extensión PDF/JPG/PNG y tamaño máximo.
- RF05. Marcar documento como pendiente al subir o reemplazar.
- RF06. El sistema debe permitir vista de estado de validación.
- RF07. El sistema debe permitir pruebas de permisos y tamaño de archivo.
...
- **EstadoValidacion**: elemento necesario para cumplir la entrega.
