# Research — Gestión de horarios de atención

## Contexto

Crear, editar y eliminar horarios por día, validando rangos y duplicados.
...
- **Riesgo investigado:** Usar campos inconsistentes `dia` vs `dia_semana`.. **Mitigación:** tratarlo como criterio de revisión antes de merge.
- **Riesgo investigado:** Permitir horarios duplicados.. **Mitigación:** tratarlo como criterio de revisión antes de merge.
- **Riesgo investigado:** No contemplar parqueaderos 24h si apertura igual cierre.. **Mitigación:** tratarlo como criterio de revisión antes de merge.



## Rationale final

La decisión técnica propuesta permite implementar Gestión de horarios de atención de forma incremental, verificable y consistente con la constitución del proyecto.
