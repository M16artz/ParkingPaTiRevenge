# Feature 009 — Gestión de horarios de atención
...
Como usuario del sistema, quiero completar el flujo de **Gestión de horarios de atención** para avanzar en la operación de ParkingPaTi sin depender de pasos manuales externos.
...
**Dado** que el usuario se encuentra en el flujo de gestión de horarios de atención,
...
- RF01. Asegurar unique `(parqueadero, dia)`.
- RF02. El sistema debe validar apertura menor a cierre.
- RF03. El sistema debe permitir UI por días de semana.
- RF04. Permitir activar/desactivar día mediante creación/eliminación lógica o física.
- RF05. Sincronizar carga inicial con `mios`.
- RF06. Probar duplicado y horario inválido.
...
- **DiasSemana**: elemento necesario para cumplir la entrega.
