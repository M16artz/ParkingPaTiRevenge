# Feature 007 — Creación y configuración general de parqueadero
...
Como usuario del sistema, quiero completar el flujo de **Creación y configuración general de parqueadero** para avanzar en la operación de ParkingPaTi sin depender de pasos manuales externos.
...
**Dado** que el usuario se encuentra en el flujo de creación y configuración general de parqueadero,
...
- RF01. El sistema debe permitir DTO de creación con dirección y ubicación.
- RF02. El sistema debe validar propietario autenticado.
- RF03. El sistema debe permitir endpoint `mios`.
- RF04. El sistema debe permitir pantalla de configuración general.
- RF05. El sistema debe permitir selector de disponibilidad.
- RF06. Actualizar servicios frontend.
- RF07. Probar propietario no puede editar parqueadero ajeno.
...
- **Propietario**: elemento necesario para cumplir la entrega.
